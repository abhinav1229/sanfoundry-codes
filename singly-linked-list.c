...
/* 
* function will show empty list message
*/
void empty_message()
{
    printf("\n\tList is Empty!\n");
...
/* 
* creates a new node and return the address of that node
*/
...
void insert_at_position(int data, int pos)
{
    ...
    //if list is empty and position is greater than the 1
    ...
    // if list is not empty and position is out of range
    ...
    if(new_node != NULL)
    {
        ...
        //if position is 1 then insertion at beginning
        if(pos == 1)
        {
            new_node->next = head;
            head = new_node;
...
void delete_at_beginning()
{
    ...
    //move head to the next node to the head
    head = head->next;
    free(temp);
...
/* 
* update the node with given new data
*/
...
/* 
* prints the list from end of the list
*/
...
/* 
* getting position of the node from the user
*/
int getPosition()
{
    int pos;
